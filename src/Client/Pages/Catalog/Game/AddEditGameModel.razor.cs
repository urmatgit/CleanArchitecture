...
{
    public partial class AddEditGameModal
    {
        [Inject] private IGameManager GameManager { get; set; }

        [Parameter] public AddEditGameCommand AddEditGameModel { get; set; } = new();
        ...
        {
            var response = await GameManager.SaveAsync(AddEditGameModel);
